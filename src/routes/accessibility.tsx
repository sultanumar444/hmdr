...
export const Route = createFileRoute("/accessibility")({
  ...
  component: () => (
    <ArticlePage
      ...
      hideCTA
    >
      <p>HMD Research is committed to making this website and the Orlando research center usable for everyone. We aim for reasonable conformance with WCAG accessibility guidance and welcome feedback.</p>
